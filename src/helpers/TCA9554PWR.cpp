...
void ST7701_reset(){
  ...
  // 4. Reset the touch controller via PCA9554
  //    Touch reset = EXIO_PIN2 (GPIO1)
  Set_EXIO(EXIO_PIN2, Low);    // Pull reset LOW
  delay(100);
  Set_EXIO(EXIO_PIN2, High);   // Release reset HIGH
  delay(100);
}
...
void st7701_init() {
  ...
  // chip select bring exio 3 low w 10 ms delay

  // send initialization commands

  //CS disable bring exio 3 high w 10 ms delay

  //configure rgb panel w pins
